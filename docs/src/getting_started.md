...
The *ProbabilityDistributions* package is available through the Julia package system by running `Pkg.add("ProbabilityDistributions")`.
...
```julia
julia> using Random, Distributions, ProbabilityDistributions
